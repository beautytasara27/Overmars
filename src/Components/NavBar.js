...
function NavBar() {
  return (
    <div id="menu-nav" class="container">
      ...
      <div id="navigation-bar" className="row justify-content-between">
        <div className="col-3"><h1 className="logo">OverMars</h1></div>
        <div className="col"><ul className="listNone">
